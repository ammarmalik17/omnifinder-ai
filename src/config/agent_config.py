...
class AgentConfig:
    ...
    # Tool configuration
    enabled_tools: List[SearchToolType] = field(
    ...
    complex_query_indicators: List[str] = field(
        default_factory=lambda: [
            "compare",
            "contrast",
            "analyze",
    ...
    def get_tool_config(self, tool_type: SearchToolType) -> Dict[str, Any]:
        ...
        tool_configs = {
            SearchToolType.WIKIPEDIA: {"results": self.wikipedia_results},
            SearchToolType.ARXIV: {"max_results": self.arxiv_max_results},
            SearchToolType.DUCKDUCKGO: {"max_results": self.duckduckgo_max_results},
            SearchToolType.WEB_SEARCH: {"max_results": self.web_search_max_results},
        }
